...
**Phase 2 timing.** Opening the core _before_ the plugin system exists means you're publishing an architecture that can't yet be extended. Better to open-source once Phase 2 is in place — otherwise the extension story is "wait for v2."
...
- Clauses asserting that IP _created for the client_ belongs to the client
