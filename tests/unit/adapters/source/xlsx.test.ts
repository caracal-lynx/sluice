...
async function writeXlsx(filePath: string, sheets: Record<string, Array<Record<string, unknown>>>): Promise<void> {
...
describe('XlsxSourceAdapter', () => {
  ...
  it('reads a single-sheet XLSX and stages rows as VARCHAR', async () => {
    ...
    await writeXlsx(file, { Data: [{ id: '1', name: 'a' }, { id: '2', name: 'b' }] });
