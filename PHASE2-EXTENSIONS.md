...
**Phase 2 merge implementation by: Michael Scott, Caracal Lynx Limited (SC826823)**
  ...
  [file]      ifsCostCentre                             (clients/cochran/plugins/)
  [composite] eribeStyleNo, eribeColourCode, positivePrice  (shared/rules.yaml)
...
Loaded transform plugins (5):
  ...
  [file]      erpAccountFormat, seasonFromDate          (clients/cochran/plugins/)
```
