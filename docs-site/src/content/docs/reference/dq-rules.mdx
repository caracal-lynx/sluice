...
- **Tier 3 — npm packages** — publish a reusable rule package under your own scope and declare it in `sluice.config.yaml`.

Caracal Lynx maintains private rule packs for **UK compliance**, **garment and textile data** and **dates and UK bank holidays**, provided as part of a paid engagement; see [Commercial Support](/sluice/commercial-support/).
