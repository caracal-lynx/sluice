...
Caracal Lynx maintains private rule packages for **UK compliance** (`@caracal-lynx/etl-rules-uk`) and **fashion/retail data standards** (`@caracal-lynx/etl-rules-fashion`); see [Commercial Support](/sluice/commercial-support/).
